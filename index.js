...
*/
console.log(createMenuItem("Batsicles", 5, "dessert"));
console.log(createMenuItem("Halloween Cookies", 10, "dessert"));
console.log(createMenuItem("Boneless Jello", 1, "dessert"));
...
reviews.push("Nate", 5 , "It was awesome!");
